...
class Set_bound:    
    def __init__(self) -> None :
        self.mean_dir = pd.read_csv("shipsim/ship/esso_osaka/inputfile/MMG_params_EssoOsaka3m_mean_lim.csv",header=0, index_col=0 )
        self.var_dir = pd.read_csv("shipsim/ship/esso_osaka/inputfile/MMG_params_EssoOsaka3m_var_lim.csv",header=0, index_col=0 )
