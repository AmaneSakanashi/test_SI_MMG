...
import pandas as pd
from subroutine  import read_optparam
...
class MmgModel():
    ...
    def __init__(self, init_const, init_parameter, model_switch):
        ...
        ### Parameter Init ###
        self.MassX_nd      = init_parameter.at['massx_nd','value'] 
        self.MassY_nd      = init_parameter.at['massy_nd','value'] 
        self.IJzz_nd       = init_parameter.at['IzzJzz_nd','value'] 
        # Hull
        self.Xuu_nd        = init_parameter.at['xuu_nd','value'] 
        self.Xvr_nd        = init_parameter.at['xvr_nd','value'] 
        self.Yv_nd         = init_parameter.at['yv_nd','value'] 
        self.Yr_nd         = init_parameter.at['yr_nd','value']
        self.Nv_nd         = init_parameter.at['nv_nd','value'] 
        self.Nr_nd         = init_parameter.at['nr_nd','value'] 
        self.CD            = init_parameter.at['coeff_drag_sway','value']#0.500
        self.C_rY          = init_parameter.at['cry_cross_flow','value'] #1.00
        self.C_rN          = init_parameter.at['crn_cross_flow','value'] #0.50
        self.X_0F_nd       = self.Xuu_nd
        self.X_0A_nd       = init_parameter.at['coeff_drag_aft','value']
        # Propeller
        self.t_prop        = init_parameter.at['t_prop','value']  
        self.wP0           = init_parameter.at['w_prop_zero','value']  
        self.tau           = init_parameter.at['tau_prop','value'] 
        self.CP_nd         = init_parameter.at['coeff_cp_prop','value'] 
        self.xP_nd         = init_parameter.at['xp_prop_nd','value'] 
        self.kt_coeff      = np.array([init_parameter.at['kt_coeff0','value'], init_parameter.at['kt_coeff1','value'], 
                                        init_parameter.at['kt_coeff2','value']]) 
        self.Ai            = np.array([init_parameter.at['ai_coeff_prop0','value'], init_parameter.at['ai_coeff_prop1','value'], 
                                        init_parameter.at['ai_coeff_prop2','value'], init_parameter.at['ai_coeff_prop3','value'],
                                        init_parameter.at['ai_coeff_prop4','value'], init_parameter.at['ai_coeff_prop5','value'],
                                        init_parameter.at['ai_coeff_prop6','value'], init_parameter.at['ai_coeff_prop7','value']]) 
        self.Bi            = np.array([init_parameter.at['bi_coeff_prop0','value'], init_parameter.at['bi_coeff_prop1','value'], 
                                        init_parameter.at['bi_coeff_prop2','value'], init_parameter.at['bi_coeff_prop3','value'],
                                        init_parameter.at['bi_coeff_prop4','value'], init_parameter.at['bi_coeff_prop5','value'],
                                        init_parameter.at['bi_coeff_prop6','value'], init_parameter.at['bi_coeff_prop7','value']])
        self.Ci            = np.array([init_parameter.at['ci_coeff_prop0','value'], init_parameter.at['ci_coeff_prop1','value'], 
                                        init_parameter.at['ci_coeff_prop2','value'], init_parameter.at['ci_coeff_prop3','value']] )
        self.Jmin          = -0.5  # -0.5 coeff. from exp
        self.alpha_p       = 1.5  # 1.5  coeff. from exp   
        
        # Rudder
        self.t_rudder           = init_parameter.at['t_rudder','value'] 
        self.ah_rudder          = init_parameter.at['ah_rudder','value']
        self.xh_rudder_nd       = init_parameter.at['xh_rudder_nd','value'] 
        self.lr_rudder_nd       = init_parameter.at['lr_rudder_nd','value']
        self.kx_rudder          = init_parameter.at['kx_rudder','value']
        self.kx_rudder_reverse  = init_parameter.at['kx_rudder_reverse','value']
        self.epsilon_rudder     = init_parameter.at['epsilon_rudder','value']
        self.cpr_rudder         = init_parameter.at['cpr_rudder','value'] 
        self.gammaN             = init_parameter.at['gammaN_rudder','value']
        self.gammaP             = init_parameter.at['gammaP_rudder','value']
        self.coeff_urudder_zero = init_parameter.at['coeff_urudder_zero','value']
        ...
        if 'XX0' in init_parameter.index :
            self.XX0 = init_parameter.at['XX0','value'] 
            self.XX1 = init_parameter.at['XX1','value'] 
            self.XX3 = init_parameter.at['XX3','value'] 
            self.XX5 = init_parameter.at['XX5','value'] 
            self.YY1 = init_parameter.at['YY1','value']
            self.YY3 = init_parameter.at['YY3','value']
            self.YY5 = init_parameter.at['YY5','value']
            self.NN1 = init_parameter.at['NN1','value']  
            self.NN2 = init_parameter.at['NN2','value']  
            self.NN3 = init_parameter.at['NN3','value']
            self.KK1 = 0
            self.KK2 = 0
            self.KK3 = 0
            self.KK5 = 0  
        ...
        ### When debugging, comment out the following
        mmgparam = read_optparam.UpdateParam()
        mmg_params_vector = mmgparam.update()
